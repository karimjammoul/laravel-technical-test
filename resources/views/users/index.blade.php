    ...
    <div class="card mb-5 mb-xl-8  py-5 px-5">
        ...
        <div class="card-body">
            ...
            <div class="table-responsive">
                <!--begin::Table-->
                <table class="table table-row-bordered table-row-gray-100 align-middle gs-0 gy-3" id="users_table">
                    <!--begin::Table head-->
                    <thead>
                    ...
                    <tbody>
                        @forelse($users as $user)
                            <tr>
                                ...
                                <td>
                                    <span class="text-muted fw-bold d-block fs-7">{{ $user['id'] }}</span>
                                </td>
                                <td>
                                    <div class="d-flex align-items-center">
                                        <img src="{{ $user['avatar'] }}" alt="" class="rounded-circle mb-3" style="width: 50px;"/>
                                    </div>
                                </td>
                                <td>
                                    <span class="text-muted fw-bold d-block fs-7">{{ $user['first_name'] }}</span>
                                </td>
                                <td>
                                    <span class="text-muted fw-bold d-block fs-7">{{ $user['last_name'] }}</span>
                                </td>
                                <td>
                                    <span class="text-muted fw-bold d-block fs-7">{{ $user['email'] }}</span>
                                </td>
                                <td class="text-end">
                                    <a href="#">
